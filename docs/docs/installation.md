...
The simplest way to install CALFEM for Python is via pip. This procedure
will ensure that all required dependencies are fulfilled.
...
If you don't want to install all packages directly in the base Anaconda
environment you could create a new enviroment for CALFEM:

    conda create -n calfem-dev python=3.9
    conda activate calfem-dev 

Now we can install CALFEM for Python and its dependencies directly into
this environment using Pip.:
